...
HD_PWD='C:/Users/37529/Desktop/project_dop/project_dop.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log main_unit.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source main_unit.tcl

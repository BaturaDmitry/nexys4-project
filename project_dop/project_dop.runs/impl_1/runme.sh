...
HD_PWD='C:/Users/37529/Desktop/project_dop/project_dop.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log main_unit.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source main_unit.tcl -notrace
